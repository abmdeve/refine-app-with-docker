...
import { dataProvider, API_URL } from "../data/index";
...
export const authProvider: AuthBindings = {
  login: async ({ email }) => {
    try {
      ...
      // this will call dataProvider with will go through the fetchwrapper function
      ...
      return {
        success: false,
        message: "message" in error ? error.message : "Login failled",
  ...
  getIdentity: async () => {
    ...
    try {
      ...
      // we'll add some queries and mutations later and change this to User wich will be generated by codegen.
